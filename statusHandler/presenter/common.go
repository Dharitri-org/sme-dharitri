...
func (psh *PresenterStatusHandler) computeRewardsInMoa() *big.Float {
	...
	rewardsInMoa := big.NewFloat(0).Mul(big.NewFloat(0).SetInt(rewardsValue), denominationCoefficient)
	return rewardsInMoa
}
