...
`
	...
	address = cli.StringFlag{
		Name:        "address",
		Usage:       "Address and port number on which the application will try to connect to the sme-dharitri node",
...
func initCliFlags() {
	...
	cliApp.Usage = "Logviewer application used to communicate with sme-dharitri node to log the message lines"
...
func startLogViewer(ctx *cli.Context) error {
	...
	//set this log's level to the lowest desired log level that matches received logs from sme-dharitri
