...
# Path to sme-dharitri. Determined automatically. Do not change.
...
# Path to dharitri-deploy-go, branch: master. Default: near sme-dharitri.
export CONFIGGENERATORDIR="$(dirname $DHARITRIDIR)/dharitri-deploy-go/cmd/filegen"
...
# Always rebuild Core from its sources and copy the executable to the testnet folder.
export ALWAYS_BUILD_CORE=1
...
########################################################################
# Proxy configuration (WARNING: dharitri-proxy-go is a private repository)

# Path to dharitri-proxy-go, branch: master. Default: near sme-dharitri.
export PROXYDIR="$(dirname $DHARITRIDIR)/dharitri-proxy-go/cmd/proxy"
...
########################################################################
# TxGen configuration (WARNING: dharitri-txgen-go is a private repository)

# Path to dharitri-txgen-go, branch: EN-5018/adapt-for-sc-core (will change eventually). Default: near sme-dharitri.
export TXGENDIR="$(dirname $DHARITRIDIR)/dharitri-txgen-go/cmd/txgen"
