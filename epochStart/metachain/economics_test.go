...
func TestComputeEndOfEpochEconomics(t *testing.T) {
	...
	totalSupply, _ := big.NewInt(0).SetString("20000000000000000000000000000", 10) // 20 Billions MOA
	nodePrice, _ := big.NewInt(0).SetString("1000000000000000000000", 10)          // 1000 MOA
	roundDuration := 4
	...
	testInputs := []testInput{
		{blockPerEpochOneShard: roundsPerEpoch, accumulatedFeesInEpoch: intToMoa(1000), devFeesInEpoch: intToMoa(1000)},
		{blockPerEpochOneShard: roundsPerEpoch / 2, accumulatedFeesInEpoch: intToMoa(1000), devFeesInEpoch: intToMoa(1000)},
		{blockPerEpochOneShard: roundsPerEpoch / 4, accumulatedFeesInEpoch: intToMoa(1000), devFeesInEpoch: intToMoa(1000)},
		{blockPerEpochOneShard: roundsPerEpoch / 8, accumulatedFeesInEpoch: intToMoa(1000), devFeesInEpoch: intToMoa(1000)},
		{blockPerEpochOneShard: roundsPerEpoch / 16, accumulatedFeesInEpoch: intToMoa(1000), devFeesInEpoch: intToMoa(1000)},
		{blockPerEpochOneShard: roundsPerEpoch / 32, accumulatedFeesInEpoch: intToMoa(1000), devFeesInEpoch: intToMoa(1000)},
		{blockPerEpochOneShard: roundsPerEpoch / 64, accumulatedFeesInEpoch: intToMoa(100000000000000), devFeesInEpoch: intToMoa(10000000)},
		{blockPerEpochOneShard: roundsPerEpoch, accumulatedFeesInEpoch: intToMoa(100000000000000), devFeesInEpoch: intToMoa(30000000000000)},
	}
...
func printEconomicsData(eb *block.Economics, hitRate float64, numBlocksTotal int64) {
	...
	fmt.Printf("Total supply: %vMOA, TotalToDistribute %vMOA, "+
		"TotalNewlyMinted %vMOA, RewardsPerBlock %vMOA, RewardsForProtocolSustainability %vMOA, NodePrice: %vMOA",
...
func intToMoa(value int) *big.Int {
