...
// TriggerHardforkHandler interface defines methods that can be used from `dharitriFacade` context variable
...
func Trigger(c *gin.Context) {
	ef, ok := c.MustGet("dharitriFacade").(TriggerHardforkHandler)
	if !ok {
		c.JSON(
