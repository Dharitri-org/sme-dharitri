...
// DharitriHandler interface defines methods that can be used from `dharitriFacade` context variable
// TODO rename DharitriHandler (take out Dharitri part)
type DharitriHandler interface {
	IsInterfaceNil() bool
}
