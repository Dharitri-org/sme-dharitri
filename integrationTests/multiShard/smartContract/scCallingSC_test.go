...
import (
	...
	factory2 "github.com/Dharitri-org/sme-dharitri/vm/factory"
...
func TestScDeployAndChangeScOwner(t *testing.T) {
	...
	// deploy the smart contracts
	firstSCAddress := putDeploySCToDataPool("../../vm/core/testdata/counter/counter.wasm", firstSCOwner, 0, big.NewInt(50), "", nodes)
...
func putDeploySCToDataPool(
	...
	scAddressBytes, _ := blockChainHook.NewAddress(pubkey, nonce, factory.CoreVirtualMachine)
	...
	tx := &transaction.Transaction{
		...
		Data:     []byte(scCodeString + "@" + hex.EncodeToString(factory.CoreVirtualMachine) + "@" + scCodeMetadataString + initArgs),
