...
func TestUpgrades_ParentAndChildContracts(t *testing.T) {
	...
	childInitialCode := core.GetSCCode("../testdata/hello-v1/output/answer.wasm")
	...
	childUpgradedCode := core.GetSCCode("../testdata/hello-v2/output/answer.wasm")
...
func TestUpgrades_HelloTrialAndError(t *testing.T) {
	...
	deployTxData := fmt.Sprintf("%s@%s@0100", core.GetSCCode("../testdata/hello-v1/output/answer.wasm"), hex.EncodeToString(factory.CoreVirtualMachine))
	upgradeTxData := fmt.Sprintf("upgradeContract@%s@0100", core.GetSCCode("../testdata/hello-v2/output/answer.wasm"))
	...
	scAddress, _ := network.Node.BlockchainHook.NewAddress(alice, 0, factory.CoreVirtualMachine)
...
func TestUpgrades_CounterTrialAndError(t *testing.T) {
	...
	deployTxData := fmt.Sprintf("%s@%s@0100", core.GetSCCode("../testdata/counter/output/counter.wasm"), hex.EncodeToString(factory.CoreVirtualMachine))
	upgradeTxData := fmt.Sprintf("upgradeContract@%s@0100", core.GetSCCode("../testdata/counter/output/counter.wasm"))
