...
func TestInterceptedTxWhithoutDataField(t *testing.T) {
	...
	testInterceptedTxFromFrontendGeneratedParams(
		...
		0,
		value,
		"moa12dnfhej64s6c56ka369gkyj3hwv5ms0y5rxgsk2k7hkd2vuk7rvqxkalsa",
		"moa1r37vju4vtruk5nnxrudnfg2ajy64xr0ztceqhcljlce648a258wswwv9zy",
...
func TestInterceptedTxWhithDataField(t *testing.T) {
	...
	testInterceptedTxFromFrontendGeneratedParams(
		...
		value,
		"moa12dnfhej64s6c56ka369gkyj3hwv5ms0y5rxgsk2k7hkd2vuk7rvqxkalsa",
		"moa14t6l0x27w4d4354sqfm40wuv9p0r49uzl9598eka290x9kws2nvqlkc36j",
