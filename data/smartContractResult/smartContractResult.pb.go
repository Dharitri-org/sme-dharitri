...
import (
	...
	github_com_Dharitri_org_sme_vm_common "github.com/Dharitri-org/sme-vm-common"
...
type SmartContractResult struct {
	...
	Value          *math_big.Int                                  `protobuf:"bytes,2,opt,name=Value,proto3,casttypewith=math/big.Int;github.com/Dharitri-org/sme-dharitri/data.BigIntCaster" json:"value"`
	...
	RelayedValue   *math_big.Int                                  `protobuf:"bytes,6,opt,name=RelayedValue,proto3,casttypewith=math/big.Int;github.com/Dharitri-org/sme-dharitri/data.BigIntCaster" json:"relayedValue"`
	...
	CallType       github_com_Dharitri_org_sme_vm_common.CallType `protobuf:"varint,13,opt,name=CallType,proto3,casttype=github.com/Dharitri-org/sme-vm-common.CallType" json:"callType"`
...
func (m *SmartContractResult) GetCallType() github_com_Dharitri_org_sme_vm_common.CallType {
	if m != nil {
		return m.CallType
	}
	return 0
...
var fileDescriptor_edc1605de0d3d805 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 13:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CallType |= github_com_Dharitri_org_sme_vm_common.CallType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
